...
$arr_tmp = array('name'=>'name','address'=>'province','grade'=>'grade','phone'=>'phone','email'=>'email','date'=>'cdate', 'action'=>array('1','2','3'));
for($i=0; $i<18; $i++){
    $_arr = array();
...
function name( $num = 2 ){
    ...
    return $arr_x[ rand(0, count($arr_x)-1) ] . $arr_m[ rand(0, count($arr_m)-1) ];
}
...
function email(){
    ...
    $arr_mail = array('163.com','126.com','qq.com','gmail.com');
    $max = strlen($strPol)-1;
    $length = rand(6, 12);
    ...
    return $str. '@' .$arr_mail[rand(0,count($arr_mail)-1)];
}
...
// 生成年级
function grade(){
    $arr = array('一年级','二年级','三年级','四年级','五年级','六年级','七年级','八年级','九年级','初一','初二','初三','高一','高二','高三','大一','大二','大三','大四');
...
// 生成省份
function province(){
    $arr = array('安徽','北京','重庆','福建','甘肃','广东','广西','贵州','海南','河北','黑龙江','河南','香港','湖北','湖南','江苏','江西','吉林','辽宁','澳门','内蒙古','宁夏','青海','山东','上海','山西','陕西','四川','台湾','天津','新疆','西藏','云南','浙江','海外');
